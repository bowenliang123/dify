...
const options = [
  { id: 'gpt-3.5-turbo-16k', name: 'chatglm3(私有云)', type: AppType.chat },
  { id: 'gpt-4', name: '百度文心4.0(公有云)', type: AppType.chat }, // 8k version
  { id: 'gpt-3.5-turbo', name: '讯飞星火V3(公有云)', type: AppType.chat },
  { id: 'gpt-4-32k', name: '百川2(私有云)', type: AppType.chat },
  { id: 'gpt-3.5-turbo-16k', name: 'chatglm3(私有云)', type: AppType.completion },
  { id: 'gpt-4', name: '百度文心4.0(公有云)', type: AppType.completion }, // 8k version
  { id: 'gpt-3.5-turbo', name: '讯飞星火V3(公有云)', type: AppType.completion },
  { id: 'gpt-4-32k', name: '百川2(私有云)', type: AppType.completion },
